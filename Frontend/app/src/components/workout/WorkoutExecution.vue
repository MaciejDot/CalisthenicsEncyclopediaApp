        ...
        if (this.username !== undefined) {
          this.$store
            ...
            .then(data => {
              ...
              this.dateOfWorkout = new Date(data.dateOfWorkout);
              this.mood = {
                value: data.mood,
  ...
  methods: {
    ...
    saveWorkout() {
      ...
      if (!this.workoutEdition) {
        this.$store.dispatch(`postWorkoutExecution`, data)
          .then(() => {
        ...
        this.$store.dispatch(`patchWorkoutExecution`, data)
          .then(() => {
            this.$router.push({ path: "/workout" });
          })
          .catch(() => {
