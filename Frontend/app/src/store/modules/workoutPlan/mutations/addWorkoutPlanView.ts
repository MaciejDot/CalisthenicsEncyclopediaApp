...
export const addWorkoutPlanView = (state: WorkoutPlanState, payload : WorkoutPlanCacheIdentityModel) : any =>
{
    ...
    state.workoutPlans.get(payload.username)?.set(payload.workoutId, payload.workoutPlan);
}