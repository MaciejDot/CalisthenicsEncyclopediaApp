export const mutations = {
  ...
  workoutExecutionViewUpdate:(state,workoutExecutionViewUpdate)=>{
    state.workoutExecutionViewUpdate = workoutExecutionViewUpdate;
  },
  workoutExecutionView:(state,workoutExecutionView)=>{
    state.workoutExecutionView = workoutExecutionView;
  }
};