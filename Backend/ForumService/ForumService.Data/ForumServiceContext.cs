...
namespace ForumService.Data
{
    ...
    {/*
        public ForumServiceContext()
            : base(new DbContextOptionsBuilder<ForumServiceContext>().UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=ForumService;Trusted_Connection=True;").Options)
        {
        }*/
